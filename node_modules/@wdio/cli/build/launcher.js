...
class Launcher {
  ...
  async run() {
    ...
    const onCompleteResults = await (0, _utils2.runOnCompleteHook)(config.onComplete, config, caps, exitCode, this.interface.result); // if any of the onComplete hooks failed, update the exit code
