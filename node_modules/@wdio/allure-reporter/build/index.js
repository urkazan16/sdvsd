...
class AllureReporter extends _reporter.default {
  ...
  onSuiteEnd(suite) {
    if (this.options.useCucumberStepReporter && suite.type === 'scenario') {
      const isPassed = !suite.tests.some(test => test.state !== _constants.testStatuses.PASSED) && !suite.hooks.some(hook => hook.state && hook.state !== _constants.testStatuses.PASSED);
